...
<span style="color:green;font-weight:700;font-size:20px">
    Note :-
</span> Docker image pushed on dockerhub is build for arm64 architecture. Please rebuild the image for x86_64/amd64 using provided Dockerfile. This image is used during deployment in kubernetes.
